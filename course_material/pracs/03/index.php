...
$exID = "03"; $PGDOC = "https://www.postgresql.org/docs/12/";
...
<p>
You can save these files to your home directory.</p>
<p>
To copy each of these files (uing schema.sql) into your home directory, do the following in terminal
</p>
<pre><code>mkdir ~/cs3311 # or choose another folder that suits (see note below)</code></pre>
<pre><code>cp ~cs3311/web/20T3/pracs/03/schema.sql ~/cs3311</code></pre>
<div class="note">
...
<li> in the editor and <tt>xterm</tt>s, change into the same prac directory
<li> edit in the local window; test your SQL by pasting into the <tt>grieg</tt> window
</ul>
</div>
...
on Grieg, so you can make use of a file <a href="clean.sql">clean.sql</a>
